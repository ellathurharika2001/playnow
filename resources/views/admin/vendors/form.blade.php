                ...
                >
                    ...
                    <div class="form-group mt-3">
                        ...
                        <select name="status" class="form-input" required>
                            <option value="approved" @selected(old('status', $vendor->status ?? 'pending') === 'approved')>Approved</option>
                            <option value="pending" @selected(old('status', $vendor->status ?? 'pending') === 'pending')>Pending</option>
                            <option value="disabled" @selected(old('status', $vendor->status ?? 'pending') === 'disabled')>Disabled</option>
                        </select>
                        @error('status')
                            <small class="text-error">{{ $message }}</small>
                        @enderror
